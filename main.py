...
▶️ `/تشغيل`
تشغيل الملف المحدد بالرد.

➕ `/إضافة`
إضافة السورة للانتظار.
...
async def command_handler(
    ...
    if command == "play":
        ...
        if not media_msg:
            ...
            await message.reply_text(
                "❌ قم بالرد (Reply) على "
                "الملف الصوتي المراد تشغيله."
            )

            return

        status_msg = await message.reply_text(
            "⏳ جاري تنزيل الملف وتشغيله..."
        )
    ...
    if command == "add":
        ...
        if not media_msg:
            ...
            await message.reply_text(
                "❌ قم بالرد على الملف "
                "الصوتي لإضافته للقائمة."
            )

            return

        status_msg = await message.reply_text(
            "⏳ جاري التنزيل والإضافة للقائمة..."
        )
